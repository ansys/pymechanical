...
def add_MechanicalServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'MechanicalService', rpc_method_handlers)
...
class MechanicalService(object):
    ...
    def RunJScript(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MechanicalService/RunJScript',
    ...
    def RunPythonScript(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MechanicalService/RunPythonScript',
            mechanical__pb2.RunScriptRequest.SerializeToString,
            mechanical__pb2.RunScriptResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Shutdown(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MechanicalService/Shutdown',
