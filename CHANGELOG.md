...
- Bump `sphinx` from 7.1.2 to 7.2.2 ([#358](https://github.com/ansys/pymechanical/pull/358))
...
- Bump `imageio` from 2.31.2 to 2.31.3 ([#376](https://github.com/ansys/pymechanical/pull/370))
