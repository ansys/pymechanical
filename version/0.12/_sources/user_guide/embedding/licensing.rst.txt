...
.. code-block:: python
    ...
    app = App(readonly=True, version={mechanical_version})
...
.. code-block:: python
    ...
    app = App(start_license="mech_1", version={mechanical_version})
...
.. code-block:: python
    ...
    app = App(readonly=True, version={mechanical_version})  # Start without checking out a license
