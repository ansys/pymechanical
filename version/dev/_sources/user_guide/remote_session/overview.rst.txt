...
.. code:: python
    ...
    exec_file_path = "C:/Program Files/ANSYS Inc/v{mechanical_version}/aisol/bin/winx64/AnsysWBU.exe"
    mechanical = launch_mechanical(
...
You can send genuine Python class commands to the app when Mechanical is active.
