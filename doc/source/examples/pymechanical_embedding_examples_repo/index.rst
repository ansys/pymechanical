.. _ref_pymechanical_embedding_examples_repository:
...
`PyMechanical embedding examples documentation <pymachanical_embedding_ex_doc_>`_.
...
The documentation to these examples can be found in the
`Basic examples <pymachanical_embedding_ex_basic_>`_ section.
