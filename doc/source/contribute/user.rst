...
welcome. You can request a new feature by creating an issue in the `PyMechanical issue`_
board.
...
in the `PyMechanical discussion`_ section.
...
of the community. You can share your work in the `PyMechanical discussion`_. Include
