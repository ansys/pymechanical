...
the embedded app, using the same Python API.

Use the :class:`~ansys.mechanical.core.embedding.logger.Configuration` class to
...
After the embedded app has been created, you can write messages to the same
log using the :class:`~ansys.mechanical.core.embedding.logger.Logger` class like this:
