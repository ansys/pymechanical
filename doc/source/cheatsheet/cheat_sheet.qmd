...
# Connect to remote session of Mechanical using python
...
print(mechanical)
```
## Launch Mechanical using cli
```{python}
#| eval: false
ansys-mechanical -r 242 --port 10000 -g
```
## Manually connect to this Mechanical session
```{python}
#| eval: false
...
# Load an embedded instance of Mechanical using python


## Start a PyMechanical embedded instance
```{python}
#| eval: false
